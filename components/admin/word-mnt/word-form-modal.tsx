...
export function WordFormModal({ open, word, onClose, onSave }: WordFormModalProps) {
  ...
  return (
    <Modal
      ...
      description={
        isEditing ? `Update the details for "${word?.word}".` : "Create a new vocabulary entry."
      }
    >
      <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
        <div className="flex-1 space-y-6 overflow-y-auto px-6 py-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label className={labelClass} htmlFor="word">
                Word
              </label>
              <input
                id="word"
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div>
              <label className={labelClass} htmlFor="audio_uk">
                Audio UK
              </label>
              <input
                id="audio_uk"
            ...
            <div>
              <label className={labelClass} htmlFor="audio_us">
                Audio US
              </label>
              <input
                id="audio_us"
          ...
          <section className="space-y-3">
            ...
            {draft.meanings.map((meaning, index) => (
              <div key={index} className="rounded-2xl border border-border bg-secondary/40 p-3">
                <div className="flex gap-3">
                  <div className="w-32 shrink-0">
                    ...
                    <select
                      ...
                      value={meaning.pos}
                      onChange={(e) =>
                        updateMeaning(index, { pos: e.target.value as PartOfSpeech })
                      }
                    >
                ...
                <div className="mt-3">
                  ...
                  <textarea
                    className={cn(fieldClass, "h-auto min-h-16 py-2.5 leading-relaxed")}
