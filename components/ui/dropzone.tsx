...
import { useSupabaseUpload, type UseSupabaseUploadReturn } from '@/hooks/use-supabase-upload';
	...
	return (
		<DropzoneContext.Provider value={{ ...restProps }}>
			<div
				{...getRootProps({
					className: cn(
						'border-2 border-gray-300 rounded-b-2xl  p-6 text-center bg-card transition-colors duration-300 text-foreground',
						className,
...
const FileUpload = (props: UploadConfig) => {
	const config = useSupabaseUpload({
		bucketName: props.bucketName,
		path: props.path,
		allowedMimeTypes: props.allowedMimeTypes || ['image/*'],
...
export { Dropzone, DropzoneContent, DropzoneEmptyState, useDropzoneContext, FileUpload };
